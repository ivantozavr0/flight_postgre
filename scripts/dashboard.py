...
app.layout = html.Div(style={'backgroundColor': colors['background']}, children=[
    ...
    Во избежание блокировки, парсинг займет некоторое время. Дашборд обновляется каждые 2.5 минуты. Вероятнее всего, через 
    этот промежуток времени на дашборде уже появятся маршруты и статистика в виде диаграмм. Если после очередного обновления информация не появилась, то на всякий случай обновите страницу вручную, бывает подтормаживание.""", 
             style={
            'color': 'white'
        }),
